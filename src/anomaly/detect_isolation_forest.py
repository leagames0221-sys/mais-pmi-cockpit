"""KPI anomaly detection (sklearn Isolation Forest + AnomSeer 2026 pattern、 ADR-304 順守)。
...
class AnomalyResult(BaseModel):
    ...
    LangGraph checkpoint msgpack serde 対応のため Pydantic BaseModel (T3 ADR-204 pattern inherit)。
    """
    ks_id: str
    kp_id: str
    day_n: int
